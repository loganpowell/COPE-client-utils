...
const assetPrCreate = ({ name, node_id, type, content, createdAt, editors, id, owner, index }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
...
const assetPrRead = ({ id }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
...
const assetPrUpdate = ({ id, content, createdAt, editors, name, node_id, owner, type, index }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
    const { content: _co, name: _na, createdAt: _cr, editors: _e, type: _t, owner: _o, node_id: _no, index: _i, } = yield assetPrRead({ id });
...
const assetPrDelete = ({ id }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
...
const assetPrConvert = ({ id }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
