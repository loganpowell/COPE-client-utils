...
const list = ({ filter, limit, nextToken, owner, sortDirection, status, createdAt, type }, authMode = GRAPHQL_AUTH_MODE.AMAZON_COGNITO_USER_POOLS) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = ((_a = data === null || data === void 0 ? void 0 : data.nodesByOwnerStatus) === null || _a === void 0 ? void 0 : _a.items) ||
        ((_b = data === null || data === void 0 ? void 0 : data.nodesByStatusType) === null || _b === void 0 ? void 0 : _b.items) ||
        ((_d = data === null || data === void 0 ? void 0 : data.listNodes) === null || _d === void 0 ? void 0 : _d.items) || data;
    return response;
});
export const node = {
    create: nodeCreate,
