...
const nodeDelete = ({ id }, authMode = GRAPHQL_AUTH_MODE.AMAZON_COGNITO_USER_POOLS) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const deletedEdges = yield Promise.all(edges === null || edges === void 0 ? void 0 : edges.items.map(({ id }) => __awaiter(void 0, void 0, void 0, function* () { return yield edge.delete({ id }); })));
