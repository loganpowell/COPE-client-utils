...
const nodeCreate = ({ id, status, type, createdAt, owner, updatedAt }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
...
const nodeRead = ({ id }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
...
const nodeUpdate = ({ id, type, status, owner, createdAt, updatedAt }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
...
const nodeDelete = ({ id }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
...
const list = ({ filter, limit, nextToken, owner, sortDirection, status, createdAt, type }, authMode) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const CA = isArray(createdAt) ? createdAt :
        [null, null];
    const V = {
        X: cleaned,
    ...
    const CAA = isArray(createdAt) ? { createdAt } :
        { createdAt: undefined };
    const CAR = !isArray(createdAt) ? { createdAt } :
        { createdAt: undefined };
