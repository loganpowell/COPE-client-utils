...
export const storeObject = ({ fileForUpload, name, id, node_id, createdAt, type, index, owner, editors, }, level = Level.protected, isPr = true) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const _a = yield Auth.currentUserInfo(), { id: user_id } = _a, rest = __rest(_a, ["id"]);
    console.log(Object.assign({ user_id }, rest));
