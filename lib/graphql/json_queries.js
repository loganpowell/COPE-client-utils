...
export const listAssets = ({ filter, limit, nextToken, } = {}) => ({
    listAssets: Object.assign(Object.assign({}, ((filter || limit || nextToken) && {
        __args: Object.assign(Object.assign(Object.assign({}, (filter && { filter })), (limit && { limit })), (nextToken && { nextToken })),
    })), { items: assetFields, nextToken: true }),
});
export const assetsByNode = ({ node_id, sortDirection, filter, limit, nextToken, }) => ({
    assetsByNode: {
        __args: Object.assign(Object.assign(Object.assign(Object.assign({ node_id }, (sortDirection && { sortDirection })), (filter && { filter })), (limit && { limit })), (nextToken && { nextToken })),
        items: assetFields,
        nextToken: true,
    },
});
export const assetsByType = ({ type, createdAt, sortDirection, filter, limit, nextToken, }) => ({
    assetsByType: {
        __args: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ type: new EnumType(type) }, (createdAt && { createdAt })), (sortDirection && { sortDirection: new EnumType(sortDirection) })), (filter && { filter })), (limit && { limit })), (nextToken && { nextToken })),
        items: assetFields,
        nextToken: true,
    },
});
export const assetsByOwnerType = ({ owner, typeCreatedAt, sortDirection, filter, limit, nextToken, }) => ({
    assetsByOwnerType: {
        __args: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ owner }, (typeCreatedAt && { typeCreatedAt })), (sortDirection && { sortDirection: new EnumType(sortDirection) })), (filter && { filter })), (limit && { limit })), (nextToken && { nextToken })),
        items: assetFields,
        nextToken: true,
    },
});
...
export const assetsPrByNode = ({ node_id, sortDirection, filter, limit, nextToken, }) => ({
    assetsPrByNode: {
        __args: Object.assign(Object.assign(Object.assign(Object.assign({ node_id }, (sortDirection && { sortDirection: new EnumType(sortDirection) })), (filter && { filter })), (limit && { limit })), (nextToken && { nextToken })),
        items: assetFields,
        nextToken: true,
    },
});
...
export const nodesByStatusType = ({ status, typeCreatedAt, sortDirection, filter, limit, nextToken, }) => ({
    nodesByStatusType: {
        __args: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ status: new EnumType(status) }, (typeCreatedAt && { typeCreatedAt })), (sortDirection && { sortDirection: new EnumType(sortDirection) })), (filter && { filter })), (limit && { limit })), (nextToken && { nextToken })),
...
export const nodesByOwnerStatus = ({ owner, statusCreatedAt, sortDirection, filter, limit, nextToken, }) => ({
    nodesByOwnerStatus: {
        __args: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ owner }, (statusCreatedAt && { statusCreatedAt })), (sortDirection && { sortDirection: new EnumType(sortDirection) })), (filter && { filter })), (limit && { limit })), (nextToken && { nextToken })),
        items: Object.assign(Object.assign({}, nodeFields), { edges: {
                items: edgeNodeFields,
                nextToken: true,
            } }),
