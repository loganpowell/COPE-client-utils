...
export declare const getAsset: ({ id }: { id: string }) => {
    getAsset: {
        id: boolean
        nodeID: boolean
        createdAt: boolean
...
export declare const getAssetPr: ({ id }: { id: string }) => {
    getAssetPr: {
        id: boolean
        nodeID: boolean
        createdAt: boolean
...
export declare const getNode: ({ id }: { id: string }) => {
    getNode: {
        edges: {
            items: {
                id: boolean
...
export declare const getEdge: ({ id }: { id: string }) => {
    getEdge: {
        id: boolean
        type: boolean
        owner: boolean
