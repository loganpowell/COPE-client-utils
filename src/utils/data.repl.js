            ...
            items: [
                {
                    ...
                    edges: {
                        items: [
                            {
                                edgeID: "942542de-9686-428e-ab33-de9d3bedb9af",
                                edge: {
                                    type: "HAS_CHILD",
                                    nodes: {
                                        items: [
                                            {
                                                nodeID: "longrandomstringthatsmyID1",
                                                createdAt: "2021-07-05T21:15:00.117Z",
                                                updatedAt: "2021-07-05T21:15:00.117Z",
                                            },
                                            {
                                                nodeID: "f844eb36-0b70-45e5-9c64-2f0d6b7743e4",
                            ...
                            {
                                edgeID: "a4b5fd21-9053-48d1-bce1-01bd651d1d51",
                                edge: {
                                    type: "HAS_CHILD",
                                    nodes: {
                                        items: [
                                            ...
                                            {
                                                nodeID: "1f205652-cc06-4763-bd2e-964c0853a13e",
                            ...
                            {
                                edgeID: "d231b8e2-4ee5-4245-a29a-dbd43f3074f0",
                                edge: {
                                    type: "HAS_CHILD",
                                    nodes: {
                                        items: [
                            ...
                            {
                                edgeID: "fa6937dc-3b9a-41f4-b3a0-2a5d3819ef4f",
                                edge: {
                                    type: "HAS_CHILD",
                                    nodes: {
                                        items: [
